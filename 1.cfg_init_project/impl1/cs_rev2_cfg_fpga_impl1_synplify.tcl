...
#-- top module name
set_option -top_module cs_rev2_cfg_fpga

#-- set result format/file last
project -result_file {C:/R_and_D/cs_rev2/CS_CFG_FPGA/impl1/cs_rev2_cfg_fpga_impl1.edi}

#-- error message log file
project -log_file {cs_rev2_cfg_fpga_impl1.srf}

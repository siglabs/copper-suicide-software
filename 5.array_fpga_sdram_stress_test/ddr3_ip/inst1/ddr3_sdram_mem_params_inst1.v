...
`define inst1_DATA_WIDTH 32
`define inst1_DATA_SIZE_32
`define inst1_x16
`define inst1_DQS_WIDTH 4
`define inst1_DQS_WIDTH_4
`define inst1_DMSIZE 4
...
`define inst1_MRS0_INIT 16'b0001010100100000
...
`define inst1_REFCLK_PERIOD_BY2 4000
`define inst1_PLL_FIN "125"

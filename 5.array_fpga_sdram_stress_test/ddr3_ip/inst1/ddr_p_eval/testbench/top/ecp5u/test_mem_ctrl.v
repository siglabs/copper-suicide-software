...
wire   [31:0]                   ddr_dq;
wire   [3:0]                    ddr_dqs;
wire   [3:0]                    inv_ddr_dqs;
wire   [3:0]                    ddr_dqm;
wire   [3:0]                    ddr_dqm_temp;
wire   [3:0]                    ddr_dqs_d;
...
initial begin
   $display ("// ==================================================");
   $display ("INFO: Current Data Bus Width is %0d bits", 31+1);
   $display ("INFO: Current Addr Bus Width is %0d bits", 27+1);
   $display ("INFO: Current User Data Bus Width is %0d bits", 127+1);
   $display ("INFO: Current User Data Mask Bus Width is %0d bits", 15+1);
...
//--------------- DIMM 0 --------------------------------------
   ...
   ddr3_dimm_32_inst1 U0_ddr3_dimm (
       .rst_n              (ddr_resetn),
       .ddr_dq             (ddr_dq),
       .ddr_dqs            (ddr_dqs),

-- =============================================================================
--  VHDL simulation model generated by IPExpress    07/17/2017    16:10:12         
--  Filename: cs_rev2_cfg_fpga_la0_sim.vhd                                          
...
entity cs_rev2_cfg_fpga_la0 is
    PORT (
        clk:		IN std_logic;
...
end cs_rev2_cfg_fpga_la0;

architecture cs_rev2_cfg_fpga_la0_u of cs_rev2_cfg_fpga_la0 is
begin

    er2_tdo <= '0';

end cs_rev2_cfg_fpga_la0_u;

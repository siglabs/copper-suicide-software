...
module inst1 (
   ...
   em_ddr_ba,
   em_ddr_addr
)/* synthesis syn_black_box black_box_pad_pin="em_ddr_data[31:0],em_ddr_dqs[3:0],em_ddr_dm[3:0],em_ddr_clk[0:0],em_ddr_odt[0:0],em_ddr_cke[0:0],em_ddr_cs_n[0:0],em_ddr_addr[27:0],em_ddr_ba[2:0],em_ddr_ras_n,em_ddr_cas_n,em_ddr_we_n" */;
...
output  [127:0]                  read_data /* synthesis syn_useioff = 0 */;
...
// Memory side signals 
inout   [31:0]                   em_ddr_data;
output                           em_ddr_reset_n;
inout   [3:0]                    em_ddr_dqs;
output  [3:0]                    em_ddr_dm;

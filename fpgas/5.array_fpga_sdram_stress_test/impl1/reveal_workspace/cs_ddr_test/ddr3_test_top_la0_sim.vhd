-- =============================================================================
--  VHDL simulation model generated by IPExpress    07/13/2017    15:48:43         
--  Filename: ddr3_test_top_la0_sim.vhd                                          
...
entity ddr3_test_top_la0 is
    PORT (
        ...
        trigger_din_6:	IN std_logic_vector (127 downto 0);
        trigger_din_7:	IN std_logic_vector (27 downto 0);
        trace_din:	IN std_logic_vector (316 downto 0);
        trigger_en:	IN std_logic;
        ip_enable:	IN std_logic
    );

end ddr3_test_top_la0;

architecture ddr3_test_top_la0_u of ddr3_test_top_la0 is
begin

    er2_tdo <= '0';

end ddr3_test_top_la0_u;
